    ...
    <aside class="content">
        ...
        <form>
            ...
            <div class="form-actions">
                ...
                <input type="submit" class="btn btn-info pull-right" value="Login" ng-hide="loading" ng-click="login()"/>
                <input type="submit" class="btn btn-info pull-right" value="Sign in..." ng-show="loading" disabled/>
