...
<div class="view" ng-hide="loading">
            ...
            <form name="frm" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="input-medium" name="lang" ng-model="Snip.lang" required>
                            ...
                            <option ng-repeat="l in langs track by $index" value="{{l}}">{{l}}</option>
                        </select>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-primary" ng-click="save()" ng-disabled="frm.$invalid || saving">
